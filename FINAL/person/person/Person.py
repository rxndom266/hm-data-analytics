def driver(config):
    ...
    idpath = '/delta/{}/{}/id'.format(client_code, data_source)
    enrichpath = '/delta/{}/person/enriched'.format(client_code, data_source)
    cdmpath = '/delta/{}/person/cdm'.format(client_code)
    ...
    identify(load_id, cleanpath, idpath, cdmpath)

    if enrich_flag==True:
        from person.enrich import enrich
